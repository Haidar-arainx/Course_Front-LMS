...
const Student = ({ formDataState }) => {
  const subTitle = formDataState?.testimonial_sub_title;
  const title = formDataState?.testimonial_title;
  return (
    <div className="student-feedbak-section padding-tb shape-img">
      <div className="container">
        <div className="section-header text-center">
          <span className="subtitle">{subTitle}</span>
          <h2 className="title">{formDataState?.testimonial_title}</h2>
        </div>
            ...
            <div className="col">
              <div className="sf-left">
                <div className="sfl-thumb">
                  <img
                    src={`${IMAGE_BASE_URL}/${formDataState?.testimonial_image}`}
