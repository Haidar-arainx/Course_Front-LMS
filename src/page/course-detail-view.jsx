...
const CourseDetailView = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="course-view-section p-5 section-bg">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="course-view">
                <div className="row justify-content-center">
                  <div className="col-lg-8 col-12 order-md-1 order-2">
                    <div className="video-part mb-4 mb-lg-0 pe-4">
                  ...
                  <div className="col-lg-4 col-sm-8 col-12 order-md-2 order-1">
